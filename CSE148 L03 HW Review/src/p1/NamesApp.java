...
public class NamesApp {
	...
	public static void main(String[] args) {
		...
		String lastNameFile = "Joyce\n" + "Kirkpatrick\n" + "Zhang\n" + "Hudson\n" + "Simpson\n" + "Cannon\n"
				...
				+ "Dougherty\n" + "Chambers\n" + "Buxton\n" + "Ahmed\n" + "Barnes\n" + "Petty\n" + "Rangel\n"
				+ "Christian\n" + "Yang\n" + "Alcock";
		String[] boys_data = boyFile.split("\t");
		String[] boys_names = new String[boys_data.length];
		for (int i = 0; i < boys_data.length; i++) {
			String[] tokens = boys_data[i].split(" ");
			boys_names[i] = tokens[1];
		}

		String[] girls_names = girlFile.split("[\t ]");
		String[] last_names = lastNameFile.split("\n");
